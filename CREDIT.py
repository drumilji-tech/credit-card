...
def main():
    ...
    if Model == "Logistic Regression":
        ...
        if Model == "Decision Tree":
            st.sidebar.subheader("Model Hyperparameters")
            criterion= st.sidebar.selectbox("Criterion(measures the quality of split)", ('gini', 'entropy'), key='criterion')
            splitter = st.sidebar.selectbox("Splitter (How to split at each node?)", ('best', 'random'), key='splitter')
